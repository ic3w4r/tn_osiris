...
[Live Demo](https://osirisai.live) · [Report Bug](https://github.com/ic3w4r/tn_osiris/issues) · [Request Feature](https://github.com/ic3w4r/tn_osiris/issues) · [Join Discord](https://discord.gg/umBykEpb98)
...
### TN-OSIRIS Clone And Run

This repository now supports a cross-platform bootstrap flow for the Tamil Nadu governance and FlowRadar module.
